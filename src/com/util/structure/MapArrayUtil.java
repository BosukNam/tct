...
public class MapArrayUtil {
     ...
     * @param k
     */
    public static void ifMapKeyPresent(Map<String, Integer> map, String k) {
     ...
     * @param key
     */
    public static void ifMapKeyAbsent(Map<String, Integer> map, String key) {
     ...
     * @return
     */
    public static Deque listToDeque(List list) {
     ...
     * @return
     */
    public static int[] integerListToIntAry(List<Integer> intList) {
     ...
     * @return
     */
    public static List<Integer> intAryToSortedList(int[] intAry) {
     ...
     * @return
     */
    public static List<Integer> intAryToList(int[] intAry) {
     ...
     * @param line
     */
    public static void makeStringCntMap(Map<String, Integer> map, String line) {
